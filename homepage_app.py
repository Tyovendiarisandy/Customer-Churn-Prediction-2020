...
def main():
    ...
    total_day_charge = st.number_input('How is Your Total Day Charge?', min_value=0.0, max_value=400.0, step=0.01, format='%f')
    total_eve_calls = st.number_input('How is Your Total Evening Calls?', min_value=0, max_value=400)
    total_eve_charge = st.number_input('How is Your Total Evening Charge?', min_value=0.0, max_value=400.0, step=0.01, format='%f')
    total_night_calls = st.number_input('How is Your Total Night Calls?', min_value=0, max_value=400)
    total_night_charge = st.number_input('How is Your Total Night Charge?', min_value=0.0, max_value=400.0, step=0.01, format='%f')
    total_intl_calls = st.number_input('How is Your Total International Calls?', min_value=0, max_value=400)
    total_intl_charge = st.number_input('How is Your Total International Charge?', min_value=0.0, max_value=400.0, step=0.01, format='%f')
